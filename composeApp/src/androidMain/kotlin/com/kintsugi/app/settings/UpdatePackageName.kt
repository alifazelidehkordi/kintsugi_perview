...
fun updateLauncherName(
    ...
    val (aliasToEnable, aliasToDisable) =
        if (index == 0) {
            KintsugiLauncherAlias::class.java to ProductivityLauncherAlias::class.java
        } else {
            ProductivityLauncherAlias::class.java to KintsugiLauncherAlias::class.java
        }
