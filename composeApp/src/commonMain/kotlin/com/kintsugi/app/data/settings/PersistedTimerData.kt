 ...
 */
package com.kintsugi.app.data.settings

import com.kintsugi.app.bl.TimerRuntimeState
...
data class PersistedTimerState(
    ...
    fun toRuntimeState() =
        TimerRuntimeState(
            ...
            state = com.kintsugi.app.bl.TimerState.entries[state],
            type = com.kintsugi.app.bl.TimerType.entries[type],
