...
import com.kintsugi.app.data.settings.AppSettings
import com.kintsugi.app.data.settings.BackupSettings
import com.kintsugi.app.data.settings.BreakBudgetData
import com.kintsugi.app.data.settings.HistoryChartSettings
import com.kintsugi.app.data.settings.LongBreakData
import com.kintsugi.app.data.settings.NotificationPermissionState
import com.kintsugi.app.data.settings.ProductivityReminderSettings
...
import com.kintsugi.app.data.settings.UiSettings
...
class FakeSettingsRepository(
    ...
    override suspend fun setPersistedTimerState(state: com.kintsugi.app.data.settings.PersistedTimerState?) {
        _settings.emit(
